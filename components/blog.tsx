        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-16">
          <div>
            ...
            <h2 className="font-serif text-5xl md:text-7xl text-white leading-none">
              {t.blog_line1}<br />
              <span className="text-[#FF6B5B]">{t.blog_line2}</span>
            </h2>
          </div>
          <a
            href="#"
          ...
          {blogPosts.map((post) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                <p className="font-sans text-gray-500 text-sm leading-relaxed">{post.excerpt}</p>
